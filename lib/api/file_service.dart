...
const String _fiberMail = "fiber_express_user_email";
const String _fiberPassword = "fiber_express_user_password";
...
class FileManager {
  ...
  static Future<Map<String, String>?> loadAuthDetails() async {
    SharedPreferences instance = await SharedPreferences.getInstance();
    String? email = instance.getString(_fiberMail);
    String? password = instance.getString(_fiberPassword);
